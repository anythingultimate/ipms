          ...
          <div className='overflow-hidden'>
            <table className='min-w-full text-center border'>
              ...
              <tbody>
                ...
                <MultiSpanSubData updateParentTotal={updateParentTotal} sn="5" kpi='Restoration of DSLAMs i.r.o. PCM faults (no. of hrs)' weightage="15%" target="12" good="36" vgood="24" exl="12" rows="3" />
