          ...
          <div className='overflow-hidden'>
            <table className='min-w-full text-center border'>
              ...
              <tbody>
                ...
                <MultiSpanSubData updateParentTotal={updateParentTotal} sn="3" kpi={'Restoration of BTS - 2G, 3G & CDMA i.r.o. PCM faults (no. of hrs)'} weightage="15%" target="12" good="36" vgood="24" exl="12" rows="2" />
                <MultiSpanSubData updateParentTotal={updateParentTotal} sn="4" kpi='Percentage of faulty BTS attended to restore fluctuation problem, error in transmission media in a month' weightage="15%" target="100%" good="60%" vgood="80%" exl="100%" rows="3" />
                <MultiSpanSubData updateParentTotal={updateParentTotal} sn="5" kpi='Restoration of DSLAMs i.r.o. PCM faults (no. of hrs)' weightage="15%" target="12" good="36" vgood="24" exl="12" rows="2" />
                <MultiSpanSubData updateParentTotal={updateParentTotal} sn="6" kpi='Time taken for providing new media for new EB circuits, BTS, RLU, DSLAM etc. (no. of hrs)' weightage="15%" target="12" good="36" vgood="24" exl="12" rows="3" />
                ...
                <MultiSpanSubData updateParentTotal={updateParentTotal} sn="8" kpi='Reporting and reviewing of APAR of all subordinate officers for previous year by 30th June.(delay in days)' weightage="5%" target="0" good="30" vgood="15" exl="0" rows="3" />
