          ...
          <div className='overflow-hidden'>
            <table className='min-w-full text-center border'>
              ...
              <tbody>
                ...
                <MultiSpanSubData  cols="34" updateParentTotal={updateParentTotal} sn="4" kpi='Percentage of faulty BTS attended to restore fluctuation problem, error in transmission media in a month' weightage="15%" target="100%" good="60%" vgood="80%" exl="100%" rows="3" />
