...
function SingleSpanData({ updateParentTotal, sn, dimension, kpi, weightage, target, good, vgood, exl }) {
  ...
  return (
    <tr className='border-b'>
      ...
      <td className='px-2 py-2 text-sm font-light text-gray-900 border-r whitespace-nowrap'>
        <textarea cols={38} rows={2} className='text-center resize-none' type='text' name='title' id='title' defaultValue={kpi} />
      </td>
      ...
      <td className='px-2 py-2 text-sm font-light text-gray-900 border-r whitespace-nowrap'>
        <textarea cols={14} rows={3} className='text-center resize-none' type='text' name='title' id='title' defaultValue={target} />
      </td>
      <td className='px-2 py-2 text-sm font-light text-gray-900 border-r whitespace-nowrap'>
