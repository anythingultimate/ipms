...
function MultiSpanSubData({updateParentTotal, sn, kpi, weightage, target, good, vgood, exl,rows, cols}) {
  ...
  return (
    <tr className='border-b'>
      ...
      <td className='px-2 py-2 text-xs font-light text-gray-900 border-r whitespace-nowrap'>
        <textarea cols={cols} rows={rows} className='text-center resize-none' type='text' name='title' id='title' defaultValue={kpi} />
      </td>
...
export default MultiSpanSubData;
